    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-4 mb-5">
                <div class="card">
                    <div class="card-body">
                        <img src="/storage/{{ $article->image }}" alt="Kegiatan" style="width:100%; object-fit: cover">
                        <p class="font-weight-bold mb-2">{{ $article->judul }}</p>
                        <p><i class="fas fa-calendar me-3"></i> {{ $article->tanggal }}</p>
                        <hr>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card embed-responsive-4by3 my-3">
                ...
                <div class="card-body">
                    ...
                    style="border:0;width:100%;object-fit:cover;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
            <!-- Side widget-->
            <div class="card my-4">
